#!/usr/bin/env python3
"""
Aggressive 2-Year Optimized Parallel Sentiment Analysis Runner - Batch 2 (Stocks 29-56)
=====================================================================================

This script runs sentiment analysis for the second batch of stocks (29-56) for 2 years (2024-2025)
...
class Aggressive2YearOptimizedRunner2:
    """Aggressive 2-year optimized parallel sentiment analysis runner for batch 2 (stocks 29-56)"""
    
    def __init__(self):
        """Initialize the aggressive 2-year optimized parallel sentiment runner"""
        self.setup_logging()
        self.logger.info("Initializing Aggressive 2-Year Optimized Parallel Sentiment Runner - Batch 2")
        ...
        # Load stocks 29-56 (second batch)
        self.stock_symbols = self.load_batch_2_stocks()
        ...
        self.output_dir = Path("2year_parallel_sentiment_batch_2")
    ...
    def setup_logging(self):
        ...
        log_file = f"2year_parallel_batch_2_sentiment_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
        logging.basicConfig(
            level=logging.INFO,
        ...
        self.logger = logging.getLogger("aggressive_2year_parallel_sentiment_runner_2")
    
    def load_batch_2_stocks(self) -> List[str]:
        """Load stocks 29-56 for batch 2"""
        return [
            "TATASTEEL.NSE", "COALINDIA.NSE", "ADANIPORTS.NSE", "BPCL.NSE", "BRITANNIA.NSE",
            "CIPLA.NSE", "DIVISLAB.NSE", "DRREDDY.NSE", "EICHERMOT.NSE", "GRASIM.NSE",
            "HEROMOTOCO.NSE", "INDUSINDBK.NSE", "SHREECEM.NSE", "UPL.NSE", "APOLLOHOSP.NSE",
            "BAJAJ-AUTO.NSE", "GODREJCP.NSE", "PIDILITIND.NSE", "TATACONSUM.NSE", "DMART.NSE",
            "ADANIENT.NSE", "ADANIPOWER.NSE", "BAJAJFINSV.NSE", "BAJFINANCE.NSE", "BHARTIARTL.NSE",
            "COLPAL.NSE", "DLF.NSE", "HCLTECH.NSE", "HDFC.NSE"
        ]
    ...
    def calculate_total_workload(self) -> Dict[str, Any]:
        """Calculate the total workload for 2-year batch 2"""
    ...
    def run_complete_analysis(self):
        """Run the complete 2-year sentiment analysis for batch 2"""
        workload = self.calculate_total_workload()
        
        self.logger.info("=" * 80)
        self.logger.info("STARTING AGGRESSIVE 2-YEAR PARALLEL BATCH 2 SENTIMENT ANALYSIS")
        self.logger.info("=" * 80)
        ...
        try:
            # Step 1: Run comprehensive backfill for batch 2 stocks and dates
            self.logger.info("Step 1: Running comprehensive backfill for batch 2 (2 years)...")
            ...
            self.logger.info("Step 2: Generating comprehensive dataset for batch 2 (2 years)...")
            ...
            daily_rollup = self.generator.rollup_aggregate(
                ...
                "D", 
                "2year_daily_sentiment_rollup_batch_2.csv"
            )
            ...
            weekly_rollup = self.generator.rollup_aggregate(
                "comprehensive_sentiment_dataset.csv", 
                "W", 
                "2year_weekly_sentiment_rollup_batch_2.csv"
            )
            ...
            monthly_rollup = self.generator.rollup_aggregate(
                "comprehensive_sentiment_dataset.csv", 
                "M", 
                "2year_monthly_sentiment_rollup_batch_2.csv"
            )
            ...
            # Save final report
            report_file = self.output_dir / "2year_batch_2_final_report.json"
            with open(report_file, 'w') as f:
                json.dump(final_report, f, indent=2)
            
            self.logger.info("=" * 80)
            self.logger.info("AGGRESSIVE 2-YEAR BATCH 2 ANALYSIS COMPLETED SUCCESSFULLY")
            self.logger.info("=" * 80)
            ...
            self.logger.error(f"Error in aggressive 2-year batch 2 analysis: {e}")
            raise
    ...
    def print_summary(self, report: Dict[str, Any]):
        ...
        self.logger.info("")
        self.logger.info("📊 AGGRESSIVE 2-YEAR BATCH 2 ANALYSIS SUMMARY")
        self.logger.info("=" * 60)
...
def main():
    ...
    try:
        runner = Aggressive2YearOptimizedRunner2()
        report = runner.run_complete_analysis()
        
        print("\n" + "="*80)
        print("✅ AGGRESSIVE 2-YEAR BATCH 2 ANALYSIS COMPLETED SUCCESSFULLY!")
        print("="*80)
        ...
        print(f"❌ Error in aggressive 2-year batch 2 analysis: {e}")
        sys.exit(1)
